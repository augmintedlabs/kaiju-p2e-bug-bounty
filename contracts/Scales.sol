...
contract Scales is IScales, ERC20, ERC721Holder, AccessControl, Pausable, ReentrancyGuard {
        ...
        ERC20("Scales", "SCALES")
    {
        ...
        KAIJU_GENESIS_SUPPLY = KAIJU.maxGenCount();
        KAIJU_MAX_SUPPLY = KAIJU.maxSupply();
     ...
     */
    function claimRWaste() public lockable onlyRole(DEFAULT_ADMIN_ROLE) {
        RWASTE.claimReward();
    }
     ...
     */
    function recoveryTransfer(address to, uint256 tokenId) public lockable onlyRole(DEFAULT_ADMIN_ROLE) {
